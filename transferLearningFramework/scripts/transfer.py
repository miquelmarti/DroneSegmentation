...
def getArguments():
    ...
    parser.add_argument('--oldcaffe', default='', help='\
    Use a previous version of caffe (expects the path to).')
...
if __name__ == "__main__":
    ...
    # Path to another version of caffe
    if args.oldcaffe != '':
        sys.path[1] = os.path.join(args.oldcaffe, 'python')
