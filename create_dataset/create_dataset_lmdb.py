...
W = 480 # Required Height
H = 360 # Required Width
dataset_name = '/home/shared/datasets/CamVid/LMDB-v2/val_lmdb/' # Folder where to create the dataset
file_with_paths = '/home/shared/datasets/CamVid/val_img.txt' # Text file with all the paths
labels = False # Set to true if ground truth
