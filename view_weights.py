...
# This disables the text written automatically by the Caffe C++ module
...
def get_arguments():
    ...
    parser.add_argument('--scale_shift', type=float, default=0.0, help='\
    Substracts the data value by this before plot')
    parser.add_argument('--scale_divide', type=float, default=1.0, help='\
...
def vis_square(data, scale_shift, scale_divide, autoscale, label="Data"):
    """Code by Caffe.
...
if __name__ == '__main__':
    ...
    net = build_network(args, args.weights)
    ...
    for layer_to_see in layers:
        ...
        data_to_show = vis_square(weights_printable, args.scale_shift,
                                  args.scale_divide, args.autoscale,
                                  layer_to_see)
